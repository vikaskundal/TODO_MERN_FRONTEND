    ...
    return <>
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <form onSubmit={
                ...
                {successMessage && <p className="text-primary-green dark:text-dark-green mb-4 text-center text-sm">{successMessage}</p>}
                
                {step === 'email' && (
                    <>
                        <p className="text-sm text-primary-dark dark:text-dark-text mb-4 text-center">
